...
void do_open( CHAR_DATA *ch, char *argument )
{
	...
	if (  IS_SET(pexit->exit_info, EX_LOCKED) )
	    ...
	    remove_bexit_flag( pexit, EX_CLOSED );
            remove_bexit_flag( pexit, EX_HIDDEN );
            remove_bexit_flag( pexit, EX_SECRET );
...
/* Maybe some furniture code will work. ?-Arcturus
...
void do_stand( CHAR_DATA *ch, char *argument )
{
	...
	{
		send_to_char("You are already standing - on your mount.\n\r",ch);
		return;
	}
...
void do_rest( CHAR_DATA *ch, char *argument )
{
	...
	if (ch->position == POS_MOUNTED)
	{
		send_to_char("You are already resting - on your mount.\n\r",ch);
		return;
	}
...
void do_sleep( CHAR_DATA *ch, char *argument )
{
	...
	switch (ch->position)
    {
		...
		case POS_FIGHTING:
			send_to_char( "You are already fighting!\n\r", ch );
			break;
            default: send_to_char("Illegal position, contact Arcturus.\n\r", ch);
                     bug("Attempting to sleep in an illegal position!.\n\r", ch);
                     break;
    }
